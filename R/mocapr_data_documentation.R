...
#' @title Motion Capture Data of Various Movements
#' @description `mocapr_data` contains motion catpure data of a number of movements.The format of the data is wide
...
#'  Please see [GitHub README.md](https://github.com/steenharsted/mocapr) for more information.
#' @format A \code{tibble}
#' \describe{
#'   \item{movement_nr}{A variable for easy reference of the movements in the dataset}
