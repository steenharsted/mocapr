...
### Import files
`mocapr`, supports import of .csv files from systems like: [the Captury](http://thecaptury.com/), [FreeMoCap](https://github.com/freemocap/freemocap), and [Optitrack](https://optitrack.com/). 
