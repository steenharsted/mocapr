...
### Import files
`mocapr` supports import of .csv files from motion capture systems like: [the Captury](http://thecaptury.com/), [FreeMoCap](https://github.com/freemocap/freemocap), and [OptiTrack](https://optitrack.com/), as well as kinematic output files (.mot) from [OpenCap](https://www.opencap.ai/). 
